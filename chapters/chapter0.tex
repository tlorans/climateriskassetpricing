...
To derive the first-order condition for $X_i$, we compute 
the expectation of agent $i$'s in period 0:
...
\begin{equation}
    ...
    = -\exp{(-a_i (1 + r_f))} \exp{(-a_i X_i^T (E_0(\tilde{r}_1) + \frac{b_i}{a_i})+\frac{1}{2}a_i^2 X_i^T \text{Var}(\tilde{r})X_i)} \\
